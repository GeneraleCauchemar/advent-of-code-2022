...
class Day09ConundrumSolver extends AbstractConundrumSolver
{
    ...
    // 6.....  (6 covers 7, 8, 9, s)
    //
    // Now, you need to keep track of the positions the new tail, 9, visits. In this example, the tail never moves, and
    // so it only visits 1 position. However, be careful: more types of motion are possible than before, so you might
