...
// For each rucksack, find the common item and return its value
$output = array_map(function ($value) {
    ...
    return getLetterValue(reset($common));
}, $input);

dump(array_sum($output));
...
// For each group of three elves, find the common item and return its value
$output = array_map(function ($value) {
    ...
    return getLetterValue(reset($badge));
}, array_chunk($input, 3));
